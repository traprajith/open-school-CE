...
function initdraggable(){
	...
	$('.checkall').click(function(e){ 
		if($('.checkall').attr('checked')){
			...
			$('#message-list-form').find(':checkbox').not('.checkall').parent().addClass('checked');
		}
		else{
			$('#message-list-form').find(':checkbox').not('.checkall').attr('checked',false);
			$('#message-list-form').find(':checkbox').not('.checkall').parent().removeClass('checked');
		}
	});
	...
	// check checkall if all checkbox list checked
	$('#message-list-form').find(':checkbox').not('.checkall').click(function(e){
		if($('input[type=checkbox].mailbox-check:checked').length == $('input[type=checkbox].mailbox-check').length){
