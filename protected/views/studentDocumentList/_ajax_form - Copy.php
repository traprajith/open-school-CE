 ...
 * @ver 1.3
 -->
 <style type="text/css">
 .fancybox-inner{width: 255px !important;}
 
 .fancybox-opened{ width:300px !important;}
 .png_bg{margin: 0 6px 0 -1px !important;}
 .client-val-form input{ width:auto}
 
 .for_radio input{ display:inline !important}
...
<?php   $formId='student-document-list-form';
   ...
   ($model->isNewRecord)?CController::createUrl('studentDocumentList/ajax_create')
    ...
    <div class="row for_radio" style="display: inline-block; margin: 0 0 -6px;">
    	<?php echo $form->labelEx($model,'mandatory'); ?><br /><br />
        <?php
        ...
        <span id="success-StudentDocumentList_is_required"
              class="hid input-notification-success  success png_bg right"></span>
        <div>
            <small></small>
        </div>
    ...
    <div class="row buttons">
        ...
        'button align-right','style'=>'width:90%;')); ?>    </div>
