...
<!--<div class="lsearch_bar">
			...
			'items'=>array(
					...
					array('label'=>''.Yii::t('app','Manage Academic Years').'<span>'.Yii::t('app','Manage All Academic Years').'</span>',  'url'=>array('/academicYears/admin'),'active'=> ((Yii::app()->controller->id=='academicYears') && (in_array(Yii::app()->controller->action->id,array('index','admin', 'view', 'update')))),'linkOptions'=>array('class'=>'gs_ico' ), 'itemOptions'=>array('id'=>'menu_1'),
					       ),
						   array('label'=>Yii::t('app','Create New Academic Year').'<span>'.Yii::t('app','Add').' & '.Yii::t('app','Update Details').'</span>', 'url'=>array('/academicYears/create'),
							'active'=> ((Yii::app()->controller->id=='academicYears') && (in_array(Yii::app()->controller->action->id,array('create'))) ? true : false),'linkOptions'=>array('class'=>'ne_ico' )),
