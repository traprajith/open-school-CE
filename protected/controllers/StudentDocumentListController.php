...
class StudentDocumentListController extends Controller
{
	/**
...
public function   init() {
  ...
  private function registerAssets(){
	...
	{
		$model=StudentDocumentList::model()->findByPk($id);
		if($model===null)
	...
	protected function performAjaxValidation($model)
	{
        ...
        $this->renderPartial('view',array('model'=>$model),false, true);
             ...
             if(isset($_POST['update_id']))$model= $this->loadModel($_POST['update_id']);else $model=new StudentDocumentList;
		...
		$model=new StudentDocumentList('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['StudentDocumentList']))
			$model->attributes=$_GET['StudentDocumentList'];
		...
		if(isset($_POST['StudentDocumentList']))
		{
           $model=$this->loadModel($_POST['update_id']);
			$model->attributes=$_POST['StudentDocumentList'];
			if(isset($_POST['StudentDocumentList']['is_required']) and $_POST['StudentDocumentList']['is_required']!=NULL){
				$model->is_required = $_POST['StudentDocumentList']['is_required'];
			}
			if(isset($_POST['StudentDocumentList']['mandatory']) and $_POST['StudentDocumentList']['mandatory']!=NULL){
				$model->mandatory = $_POST['StudentDocumentList']['mandatory'];
			}
			if( $model->save(false)){
