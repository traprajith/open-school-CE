...
class EventsTypeController extends RController
{
	/**
...
public function   init() {
  ...
  private function registerAssets(){
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='events-type-form')
		{
        ...
        $this->renderPartial('view',array('model'=>$model),false, true);
             ...
             if(isset($_POST['update_id']))$model= $this->loadModel($_POST['update_id']);else $model=new EventsType;
		...
		$model=new EventsType('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['EventsType']))
			$model->attributes=$_GET['EventsType'];
