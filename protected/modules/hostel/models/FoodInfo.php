...
/**
 * This is the model class for table "food_info".
 *
 * The followings are the available columns in table 'food_info':
 * @property integer $id
 * @property string $food_preference
 * @property string $amount
 */
class FoodInfo extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return FoodInfo the static model class
	 */
