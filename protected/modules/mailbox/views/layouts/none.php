...
<body>
  ...
  <div class="loginBox">
        	<ul>
				...
				<?php echo CHtml::link(Yii::t('app','Settings'),array('/user/profile'),array('class'=>'profile')); ?><br>
				<?php echo CHtml::link(Yii::t('app','Logout'), array('/user/logout'));?><br>
              </li>
            	<li></li>
...
<footer>
 ...
 <div class="cright">Copyright © <?php echo date('Y').' '.$college->config_value ; ?>. Powered By <a href="http://www.wiwoinc.com" target="_self">WIWO Inc</a>. </div>      </footer>
</body>
</html>
