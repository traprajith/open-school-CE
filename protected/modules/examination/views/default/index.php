		...
		<div style="padding:20px; position:relative;">
            ...
            <div class="edit_bttns" style="width:350px; top:30px; right:-15px;">
				...
				<div class="promo_bx">
                    ...
                    <a href="http://www.tryopenschool.com/index.php?r=examination" target="_blank"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/try_bttn.png" width="75" height="38" /></a>
                  </div> 
