...
$this->breadcrumbs=array(
	Yii::t('app','Teacher Departments')=>array('admin'),
	Yii::t('app','Manage'),
);
    ...
    <tr>
        ...
        <td valign="top">
            <div class="cont_right formWrapper">
                <h1><?php echo Yii::t('app','Manage Teacher Departments');?></h1>
                <?php
...
<ul>                                    
<li><?php echo CHtml::link('<span>'.Yii::t('app','Add Department').'</span>', array('create'),array('class'=>'a_tag-btn ')); ?></li>
<li></li>
<li></li>                                    
</ul>
</div> 
					...
					<div>
						<div class="yellow_bx" style="background-image:none;width:680px;padding-bottom:45px;">
							...
							<?php 
								...
								{ 
									echo Yii::t('app','To add a new department, enable Create option in Previous Academic Year Settings.');
								}
								elseif($is_create->settings_value!=0 and $is_edit->settings_value==0 and $is_delete->settings_value!=0)
								{
									echo Yii::t('app','To edit the department, enable Edit option in Previous Academic Year Settings.');
								}
								elseif($is_create->settings_value!=0 and $is_edit->settings_value!=0 and $is_delete->settings_value==0)
								{
									echo Yii::t('app','To delete the department, enable Delete option in Previous Academic Year Settings.');
								}
								else
								{
									echo Yii::t('app','To manage teacher departments, enable the required options in Previous Academic Year Settings.');	
								}
							?>
							</div>
