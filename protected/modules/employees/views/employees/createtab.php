...
<ul>
    ...
    <?php 
		if(in_array(Yii::app()->controller->action->id,array('create')) and in_array(Yii::app()->controller->id,array('employees')))
                {
                    if(isset($_REQUEST['id']))
                    {
                        echo '<li class="cur"><h2>'.CHtml::link(Yii::t('app','Teacher Details'),array('/employees/employees/create','id'=>$_REQUEST['id'])).'</h2></li>';
                    } 
                    else
                    {
                        echo '<li class="cur"><h2>'.CHtml::link(Yii::t('app','Teacher Details'),array('/employees/employees/create')).'</h2></li>';
                    }
                ...
                if(in_array(Yii::app()->controller->action->id,array('create2')) and in_array(Yii::app()->controller->id,array('employees')))
                {
                    if(isset($_REQUEST['id']))
                    {
                        echo '<li><h2 class="">'.CHtml::link(Yii::t('app','Teacher Details'),array('/employees/employees/update','id'=>$_REQUEST['id'],'type'=>1)).'</h2></li>';
                        echo '<li class="cur"><h2>'.CHtml::link(Yii::t('app','Teacher Contact Details'),array('/employees/employees/create2','id'=>$_REQUEST['id'])).'</h2></li>';
