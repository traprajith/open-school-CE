...
<?php //echo $form->textField($model,'date_of_birth',array('size'=>30,'maxlength'=>255));
					$this->widget('zii.widgets.jui.CJuiDatePicker', array(
...
<div class="txtfld-col-box">
    <div class="txtfld-col">
<?php echo $form->labelEx($model,Yii::t('app','Total Experience'),array('style'=>'float:left')); ?>&nbsp;<span class="required">*</span>
...
<?php echo $form->labelEx($model,'experience_detail',array('style'=>'float:left;')); ?>
