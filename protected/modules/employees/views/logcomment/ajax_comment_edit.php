                                ...
                                <?php $form=$this->beginWidget('CActiveForm', array(
                                	...
                                	<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     <tr>
                                      ...
                                      <tr>
                                        <td width="83%"><?php echo $form->textArea($model1,'comment',array('style'=>'width:94% !important;min-width:94%','id'=>'comment_text'));?>
                                        ...
                                        <tr><td>
                                                     ...
                                                     <?php //echo $form->checkBox($model1,'visible_t',array('style'=>'','id'=>'visible_te'));?>
                                                     <?php //echo $form->error($model1,'visible_t'); ?>
