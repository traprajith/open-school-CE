    ...
    <body>
        ...
        <header>
            ...
            <div class="loginBox">
                ...
                <li>
                    ...
                    ?>
                    <strong><?php echo ucfirst($teacher->last_name.' '.$teacher->first_name);?></strong><br>
                ...
                <li>
					...
					{
						echo '<img  src="images/portal/p-small-male_img.png" alt='.$teacher->first_name.'  width="40" height="41" />'; 
					}
					elseif($teacher->gender=='F')
					{
						echo '<img  src="images/portal/p-small-female_img.png" alt='.$teacher->first_name.'  width="40" height="41" />';
					}
					?>
                </li>
                </ul>
        ...
        <nav>
            <div style="padding:7px 0px;">
            	Welcome <strong><?php echo ucfirst($teacher->last_name.' '.$teacher->first_name);?></strong> in to your profile.
            </div> 	
        </nav>
