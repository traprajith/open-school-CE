...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="formCon" style="clear:left;">
        ...
        <?php
		 $student=Students::model()->findByAttributes(array('uid'=>$model->user_id));
		?>
          ...
          <tr>
                ...
                <td id="existing_file">
                        ...
                        <ul class="tt-wrapper">
                            ...
                            <li>
                                <?php echo CHtml::link('<span>'.Yii::t('app','Download').'</span>', array('achievements/download','id'=>$model->id,'student_id'=>$student->id),array('class'=>'tt-download')); ?>
                            </li>
                            <?php
                            if(in_array($model->file_type,$valid_image_types)) 
                            {
                            
							    $path = 'uploadedfiles/achievement_document/'.$model->user_id.'/'.$model->file;
           ...
           <div class="row" id="student_id">
            ...
            <div class="row">
                <?php echo $form->hiddenField($model,'eid',array('value'=>$_REQUEST['student_id'])); ?>
