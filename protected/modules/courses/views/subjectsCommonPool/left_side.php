...
<!--<div class="lsearch_bar">
                ...
                <div class="clear"></div>
  </div> --> <h1><?php echo Yii::t('app','Manage Courses and').' '.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id");?></h1>
    ...
    return $message;
			...
			'items'=>array(
					...
					array('label'=>''.Yii::t('app','General Settings').'<span>'.Yii::t('app','Manage Configurations').'</span>',  'url'=>array('/configurations/index'), 
							'linkOptions'=>array('class'=>'gs_ico' ), 'itemOptions'=>array('id'=>'menu_1') 
					       ),
						   
					array('label'=>Yii::t('app','List Courses and').' '.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id").' '.'<span>'.Yii::t('app','Current Courses and').' '.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id").' '.Yii::t('app','Details').'</span>', 'url'=>array('courses/managecourse'), 
						   'active'=> ((Yii::app()->controller->id=='courses') and (in_array(Yii::app()->controller->action->id,array('managecourse'))) ? true : false),'linkOptions'=>array('class'=>'lbook_ico' )),
					...
					array('label'=>Yii::t('app','Create Courses').'<span>'.Yii::t('app','Add New Course Details').'</span>', 'url'=>array('courses/create'),
						  ...
						  'linkOptions'=>array('class'=>'abook_ico' )                                                                                           
						  ),
						  
				    array('label'=>Yii::t('app','Previous Year Courses').'<span>'.Yii::t('app','All Courses and').' '.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id").' '.Yii::t('app','Details').'</span>', 'url'=>array('courses/allcourses'),
							'active'=> ((Yii::app()->controller->id=='courses') && (in_array(Yii::app()->controller->action->id,array('allcourses'))) ? true : false),'linkOptions'=>array('class'=>'sa_ico' )                          ),
					
					array('label'=>Yii::t('app','Deactivated').' '.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id").'<span>'.Yii::t('app','Deactivated').' '.Yii::app()->getModule('students')->fieldLabel("Students", "batch_id").' '.Yii::t('app','Details').'</span>', 'url'=>array('courses/deactivatedbatches'), 
						   'active'=> ((Yii::app()->controller->id=='courses') and (in_array(Yii::app()->controller->action->id,array('deactivatedbatches'))) ? true : false),
						   'linkOptions'=>array('class'=>'funp_ico' )),
					),
