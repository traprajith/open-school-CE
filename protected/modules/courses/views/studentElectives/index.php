 ...
 * StudentElectives * index.php view file
...
?><?php
 $this->breadcrumbs=array(
	 Yii::t('app','Manage Student Electives')
);
?>
<?php  
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('student-electives-grid', {
		data: $(this).serialize()
	});
	return false;
});
");
?>
<h1><?php echo Yii::t('app','StudentElectives');?> </h1>
...
<div class="right">
    <input id="add_student-electives" type="button" style="display:block; clear: both;"
           value="Create StudentElectives" class="client-val-form button">
</div>

<?php
//Strings for the delete confirmation dialog.
$del_con = Yii::t('app', 'Are you sure you want to delete this student-electives?');
...
<?php
    ...
    array(
                   'class' => 'CButtonColumn',
                    'buttons' => array(
                                                     'student-electives_delete' => array(
                                                     ...
                                                     'student-electives_update' => array(
                   ...
                   'template' => '{student-electives_view}{student-electives_update}{student-electives_delete}',
            ),
    ),
 ...
 //VIEW
    ...
    $('.fan_view').each(function(index) {
        ...
        $(this).bind('click', function() {
            $.ajax({
                type: "POST",
                url: "<?php echo Yii::app()->request->baseUrl;?>/student-electives/returnView",
                data:{"id":id,"YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken;?>"},
                beforeSend : function() {
                    $("#student-electives-grid").addClass("ajax-sending");
                },
                complete : function() {
                    $("#student-electives-grid").removeClass("ajax-sending");
                },
...
//UPDATE
    ...
    $('.fan_update').each(function(index) {
        ...
        $(this).bind('click', function() {
            $.ajax({
                type: "POST",
                url: "<?php echo Yii::app()->request->baseUrl;?>/student-electives/returnForm",
                ...
                success: function(data) {
                    $.fancybox(data,
                            {    "transitionIn"    :  "elastic",
                                ...
                                $.fn.yiiGridView.update('student-electives-grid', {url:'',data:{"StudentElectives_page":page}});
                                }//onclosed
                            });//fancybox
                    //  console.log(data);
                } //success
...
// DELETE
    ...
    $('.fan_del').each(function(index) {
        ...
        deletes[id] = function() {
            $.ajax({
                type: "POST",
                url: "<?php echo Yii::app()->request->baseUrl;?>/student-electives/ajax_delete",
                data:{"id":id,"YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken;?>"},
                    beforeSend : function() {
                    $("#student-electives-grid").addClass("ajax-sending");
                },
...
//CREATE 
    ...
    $('#add_student-electives ').bind('click', function() {
        $.ajax({
            type: "POST",
            url: "<?php echo Yii::app()->request->baseUrl;?>/student-electives/returnForm",
