...
?>
<?php 
$batch_label    =   Yii::app()->getModule('students')->batchLabel("Students", "batch_id");
$add_subject_label  =   Yii::t('app','Add Subject'); 
...
<script>
	...
	{
		$(".del_err").html("<?php echo $batch_label.' '.Yii::t('app','Successfully Deleted!'); ?>");		
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td width="247" valign="top">
        	<?php $this->renderPartial('left_side',array('batch_label'=>$batch_label));?>        
        </td>
        <td valign="top">
            <div class="cont_right formWrapper">
                <h1><?php echo Yii::t('app','Manage Courses and').' '.$batch_label;?></h1>
                ...
                <div class="mcb_Con">
							...
							<div>
								<div class="yellow_bx" style="background-image:none;width:680px;padding-bottom:45px;">
									...
									<?php 
										...
										{ 
											echo Yii::t('app','To add a new').' '.$batch_label.' '.Yii::t('app','enable Create option in Previous Academic Year Settings.');
										}
										elseif($is_create->settings_value!=0 and $is_edit->settings_value==0 and $is_delete->settings_value!=0)
										{
											echo Yii::t('app','To edit a course or').' '.$batch_label.' '.Yii::t('app','enable Edit option in Previous Academic Year Settings.');
										}
										elseif($is_create->settings_value!=0 and $is_edit->settings_value!=0 and $is_delete->settings_value==0)
										{
											echo Yii::t('app','To delete a course or').' '.$batch_label.' '.Yii::t('app','enable Delete option in Previous Academic Year Settings.');
										}
										else
										{
											echo Yii::t('app','To manage courses and').' '.$batch_label.' '.Yii::t('app','enable the required options in Previous Academic Year Settings.');	
										}
									?>
									</div>
							...
							<ul class="posctn-ul2">
								<li class="gtcol1" onclick="details('<?php echo $posts_1->id;?>');" style="cursor:pointer;">
									...
									?>
                                        ...
                                        <div style="float:left"><?php echo ' - '.$batch_label;?>, </div>
                                    <?php
									}
									?>
								...
								?>
								<li class="e-gtcol1">
									<?php echo CHtml::ajaxLink($edit_label,$this->createUrl('courses/Edit'),array(
								...
								?>
								<li class="e-gtcol1">
									<?php echo CHtml::ajaxLink($add_subject_label,$this->createUrl('subjectsCommonPool/Addnew'),
                                ...
                                <li class="e-gtcol1">
									<?php echo CHtml::ajaxLink(Yii::t('app','Add').' '.$batch_label,$this->createUrl('batches/Addnew'),
							...
							if($semester_enabled){	//enabled
                                ...
                                <div class="cours-strip" id="dropwin<?php echo $posts_1->id; ?>" style="display: none;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="cours-inner-table">
                                        <thead>
                                            ...
                                            foreach($batch as $batch_1)
                                            {
                                                ...
                                                echo CHtml::ajaxLink($edit_label,$this->createUrl('batches/addupdate'),array(
                                                ...
                                                'data' => array( 'val1' =>$batch_1->id, Yii::app()->request->csrfTokenName=>Yii::app()->request->csrfToken),'dataType' => 'text'),array('confirm'=>Yii::t('app','Are you sure you want to delete this'.' '.$batch_label).' '.'?'.Yii::t('app','Note: All details (timetable, exam) related to this').' '. $batch_label.' '.Yii::t('app','will be deleted.')));
                                                }
                                                ?> 
                                                <?php 
                                                if(($year == $current_academic_yr->config_value) or ($year != $current_academic_yr->config_value and $is_create->settings_value!=0))
                                                ...
                                                <tbody>
                                                    ...
                                                    if(count($batches)==0){
                                                        ...
                                                        foreach($batches as $batch_1){
                                                            ...
                                                            { 
                                                            $cid	=	$batch_1->course_id;	
                                                            echo ''.CHtml::ajaxLink(Yii::t('app','Delete'), $this->createUrl('batches/remove'), array('success'=>'rowdelete('.$batch_1->id.','.$batch_1->course_id.')','type' =>'POST', 'data' => array( 'val1' =>$batch_1->id, Yii::app()->request->csrfTokenName=>Yii::app()->request->csrfToken),'dataType' => 'text'),array('confirm'=>Yii::t('app','Are you sure you want to delete this'.' '.$batch_label).' '.'?'.Yii::t('app','Note: All details (timetable, exam) related to this').' '. $batch_label.' '.Yii::t('app','will be deleted.')));
                                                            }
                                                            ?> 
                                                            <?php 
                                                            if(($year == $current_academic_yr->config_value) or ($year != $current_academic_yr->config_value and $is_create->settings_value!=0))
									...
									?>
                                        <!--Remaining batches-->                                    
                                        <div class="semester-block">
                                            <div class="cours-table-hed"><h3><?php echo $batch_label.' '.Yii::t('app', 'without semester');?></h3></div>
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="cours-inner-table">
                                                <thead>
                                                    <tr>
                                                        <th  width="15%"><?php echo $batch_label.' '. Yii::t('app','Name');?></th>
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="cours-inner-table">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th width="20%"><?php echo Yii::t('app','Subject Name');?></th>
                                                        <?php /*?><td align="center" width="22%"><?php echo Yii::t('app','Subject Code');?></td><?php */?>
                                                        <th width="16%"><?php echo Yii::t('app','Maximum Weekly Classes');?></th>
                                                        <th width="20%"><?php echo Yii::t('app','First Sub Category');?></th>
                                                        <th width="20%"><?php echo Yii::t('app','Second Sub Category');?></th>
                                                ...
                                                ?>
                                                       ...
                                                       <?php /*?> <td align="center"><?php echo $subject->subject_code;?></td><?php */?>
                                                        ...
                                                        <?php
														$split_subs	=	SubjectCommonpoolSplit::model()->findAllByAttributes(array('subject_id'=>$subject->id));
															if($split_subs!= NULL){
																$k=1;
																foreach($split_subs as $split_sub){
																	if($k<=2){
																	?>
																	 <td align="center"><?php echo $split_sub->split_name;?></td>
																	<?php
																	}$k++;
																}
															}
                                                        ...
                                                        echo CHtml::ajaxLink($edit_label,$this->createUrl('subjectsCommonPool/addupdate'),array(
                    ...
                    <div>
                        ...
                        <div class="y_bx_head" style="width:650px;">
							...
							{
								echo Yii::t('app','It appears that no courses or').' '.$batch_label.' '.Yii::t('app','are created for current academic year.');
							}
							?>
                        </div>
                        <?php
                        ...
                        ?>
                        <div class="y_bx_list" style="width:650px;">
                        	<h1><?php echo CHtml::link(Yii::t('app','Add New Course').' &amp; '.$batch_label,array('courses/create')) ?></h1>
						</div>
                        </div>
                    </div>
