...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><?php echo $form->labelEx($model,Yii::t('Elective','name')); ?></td>
    <td><?php echo $form->textField($model,'name',array('size'=>30,'maxlength'=>255)); ?>
		<?php echo $form->error($model,'name'); ?></td>
    <td><?php echo $form->labelEx($model,Yii::t('Elective','batch_id')); ?></td>
    <td><?php echo $form->dropDownList($model,'batch_id', CHtml::listData(Batches::model()->findAll(), 'id', 'name'), array('empty'=>'select Batch')); ?>
		<?php echo $form->error($model,'batch_id'); ?></td>
  </tr>
  <tr>
    <td><?php //echo $form->labelEx($model,'is_deleted'); ?></td>
    <td><?php echo $form->hiddenField($model,'is_deleted'); ?>
		<?php echo $form->error($model,'is_deleted'); ?></td>
    <td><?php //echo $form->labelEx($model,'created_at'); ?></td>
    <td><?php echo $form->hiddenField($model,'created_at',array('value'=>date('Y-m-d'))); ?>
		<?php echo $form->error($model,'created_at'); ?></td>
  </tr>
  <tr>
    <td><?php //echo $form->labelEx($model,'updated_at'); ?></td>
    <td><?php echo $form->hiddenField($model,'updated_at',array('value'=>date('Y-m-d'))); ?>
