...
<div class="table_listbx">
  ...
  <table width="100%" cellspacing="0" cellpadding="0" border="0">
    <tr >
      ...
      <td class="listbx_subhdng"><?php echo Yii::t('app','Student Name');?></td>
      <td class="listbx_subhdng" align="center"><?php echo Yii::t('app','Admission Number');?></td>
    </tr>
    <tr>
      <td colspan="3" width="10%"><?php 
        ...
        <?php
					 ...
					 echo CHtml::checkBoxList('sid', '',$posts1, array('id'=>'1','template' => '{input}{label}</tr><tr><td width="10%">', 'checkAll' => 'All')); ?></td>
      <td colspan="2"></td>
    </tr>
  </table>
  <?php $data1 = CHtml::listData(Batches::model()->findAll(array('order'=>'name DESC')),'id','name');
                          echo CHtml::dropDownList('batch_id','',$data1,array('prompt'=>Yii::t('app','Select'),'id'=>'batch_id')); ?>
  <?php echo CHtml::submitButton(Yii::t('app','Promote'),array('name'=>'promote','onclick'=>'formSubmit()','class'=>'')); ?>
  <?php    	
                }
				else
				{
					echo '<br><div class="notifications nt_red" style="padding-top:10px"><i>'.Yii::t('app','No active students in this batch !').'</i></div>'; 
