 ...
 *
 * The followings are the available columns in table 'employee_departments':
 * @property integer $id
 * @property string $code
 * @property string $name
 * @property integer $status
 */
class EmployeeDepartments extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return EmployeeDepartments the static model class
	 */
