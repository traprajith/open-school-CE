...
/**
 * This is the model class for table "subject_split".
 *
 * The followings are the available columns in table 'subject_split':
 * @property integer $id
 * @property integer $subject_id
 * @property string $split_name
 */
class SubjectSplit extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return SubjectSplit the static model class
	 */
