 ...
 */
class DashboardMessage extends CActiveRecord
{
	public $modified;
	public $subject;
	public $is_replied;
	...
	public function isRead($userid)
	{
        ...
        public static function getTime($post_time)
        {        
            $time = strtotime(date('Y-m-d H:i:s')) - ($post_time); // to get the time since that moment
            $time = ($time<1)? 1 : $time;
            $tokens = array (
                31536000 => 'year',
                2592000 => 'month',
